...
$endif$\href{https://tmnf.exchange/trackshow/9797488}{\includegraphics[width=$if(titlepage-theme.logo-size)$$titlepage-theme.logo-size$$else$0.2\textwidth$endif$]{$titlepage-logo$}\newline{}(Kmita, Nicolas 2022)}}
