...
où $y$ est la valeur réelle et $p$ est la probabilité estimée.
...
## A - Programme d’échantillonnage {.unnumbered}

## B - Variables de base {.unnumbered}
...
Étiquette - Qualitative nominale
L’étiquette du circuit. (provenant de l’API de TMNF-X)

\textbf{Étiquette} - Qualitative nominale\quad{}